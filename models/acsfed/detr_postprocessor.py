...
class RTDETRPostProcessor(nn.Module):
    ...
    def forward(self, outputs, orig_target_sizes):
        ...
        if self.use_focal_loss:
            ...
            index = torch.div(index, self.num_classes, rounding_mode='trunc')  # index // self.num_classes
...
def build_postprocessor(num_classes):
    postprocessor = RTDETRPostProcessor(num_classes, use_focal_loss=True, num_top_queries=300,
